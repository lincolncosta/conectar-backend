"""Add Pessoa, Experiencia Profissional, Academica and by Project, Area, Papel, TipoAcordo, Habilidades and dependencies

Revision ID: ecfc0fcb6703
Revises: 
Create Date: 2020-10-07 07:08:09.679279-07:00
...
revision = 'ecfc0fcb6703'
down_revision = '89828782e976'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('data_atualizacao', sa.DateTime(timezone=True), onupdate=sa.text('now()'), nullable=True),
